...
##bsub -q long -oo /path/MutData-out181.%I.txt -J 'MYJOB[1-10]' -R'select[mem>MEMVAL] rusage[mem=MEMVAL]' -M MEMVAL 'R CMD BATCH --vanilla path/denovo_181.R path/${LSB_JOBINDEX}.denovo4.181.Rout'
